        ...
        {error.isError ? <p className="text-alert pdt-1">{error.text}</p> : null}
            <div className="flex flex-column flex-gap-1-5 mt-2 mr-4 mb-2 ml-4">
                ...
                <div className="flex flex-column">
                    ...
                    <div className="flex">
                        <input className="form-field pwd-box flex-grow-1 " type={showPasswordToggle ? "password": "text"} name="pwd" id="pwd" placeholder="**********" value={userDetails.password} onChange={e => setUserDetails({...userDetails, password: e.target.value})} />
                ...
                <div className="flex flex-justify-space-between flex-align-center">  
                    ...
                    <input className="profile-checkbox" type="checkbox" name="terms&conditions" id="t&c"/>
                    Remember me
                    </label>
                    <span className="forgot-password text-sm">Forgot your Password?</span>
                </div>
                <button className="btn-form-submit btn-solid btn-medium text-base" type="submit">Login</button>
                <button className="btn-form-submit btn-solid btn-medium text-base" type="button" onClick={() => testlogin()}>Login with test credentials</button>
